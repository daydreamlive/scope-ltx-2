"""
Standalone patchifier module adapted from ComfyUI's symmetric_patchifier.py
(comfy/ldm/lightricks/) for use in Scope without any comfy dependencies.
"""
...
class AudioPatchifier(Patchifier):
    ...
    def unpatchify(self, audio_latents: torch.Tensor, channels: int, freq: int) -> torch.Tensor:
        audio_latents = rearrange(audio_latents, "b t (c f) -> b c t f", c=channels, f=freq)
